<%-- 
    Document   : edit
    Created on : Sep 1, 2020, 7:52:44 AM
    Author     : root
--%>
...
<html>
    ...
    <body>
        ...
        <form action="edit.jsp" method="post"><table align="center">
                <tr>
                ...
                <tr>
                    <td>ID</td>
                    <td>
                        <input          type="text"          name="txtid" value="${param.id}">
                    </td>
                </tr>
                <tr>
                    <td>First name</td>
                    <td>
                        <input         type="text"         name="txtfirst" value="${param.f}">
                    </td>
                </tr>
                <tr>
                    <td>Last name</td>
                    <td>
                        <input         type="text"         name="txtlast" value="${param.l}">
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div class="footer" align="right"><br><hr>
